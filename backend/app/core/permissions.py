...
ACTION_PERMISSION_MAP: dict[BusinessAnalysisAction, PermissionLevel] = {
    ...
    BusinessAnalysisAction.QUALITY_AUDIT_LINEAGE: PermissionLevel.READ_STATE,
    BusinessAnalysisAction.QUALITY_SCORE_REFERENCE_ALIGNMENT: PermissionLevel.WRITE_ARTIFACT,
...
RISK_LEVEL_MAP: dict[BusinessAnalysisAction, str] = {
    ...
    BusinessAnalysisAction.QUALITY_AUDIT_LINEAGE: "low",
    BusinessAnalysisAction.QUALITY_SCORE_REFERENCE_ALIGNMENT: "low",
